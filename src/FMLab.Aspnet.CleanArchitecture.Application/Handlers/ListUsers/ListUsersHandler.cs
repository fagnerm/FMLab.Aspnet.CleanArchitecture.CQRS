...
public class ListUsersHandler : IRequestHandler<ListUsersFilter, Result<ListUsersOutputDTO>>
{
    ...
    public async Task<Result<ListUsersOutputDTO>> Handle(ListUsersFilter input, CancellationToken cancellationToken)
    {
